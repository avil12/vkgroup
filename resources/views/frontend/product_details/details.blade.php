<div class="text-left">
    <!-- Product Name -->
    <h1 class="mb-2 fs-16 fw-500 text-dark">
    ...
    @if ($detailedProduct->brand != null)
        <div class="d-flex flex-wrap align-items-center mb-1">
            <span class="text-secondary fs-12 fw-400 mr-4 w-50px">{{ translate('Brand') }}</span><br>
            <a href="{{ route('products.brand', $detailedProduct->brand->slug) }}"
                    class=" hov-text-primary fs-16 fw-700" style="color: #ef1a22">{{ $detailedProduct->brand->name }}</a>
        </div>
    @endif
        ...
        <!-- Without Wholesale -->
            @if (home_price($detailedProduct) != home_discounted_price($detailedProduct))
                <div class="row no-gutters mb-2">
                    <div class="col-sm-2">
                        <div class="text-secondary fs-12 fw-400">{{ translate('Price') }}</div>
                    </div>
                    <div class="col-sm-10">
    ...
    @if ($detailedProduct->auction_product != 1)
        <form id="option-choice-form">
            ...
            <div class="row no-gutters mb-2">
                <div class="col-lg-12">
                    <h3 class="fs-16 fw-700">Product Details</h3>
                </div>
                            ...
                            <div class="col-sm-8 col-8">
                                <div class="aiz-radio-inline">
                                    ...
                                    <label class="aiz-megabox pl-0 mr-2 mb-0">
                                        ...
                                        >
                                        <span class="rounded-0 d-flex align-items-center justify-content-center py-1 px-3">
                                           : {{ $value }}
                                        </span>
                                    </label>
                                    @endforeach
...
<hr style="margin-top:9px;margin-bottom: 8px;border: 1px solid #ededf2;">
                ...
                @if (count(json_decode($detailedProduct->colors)) > 0)
                    <div class="row no-gutters mb-2">
                        <div class="col-sm-2">
                            <div class="text-secondary fs-14 fw-500 mt-2">{{ translate('Color')}}</div>
                        </div>
                        <div class="col-sm-10">
                            <div class="aiz-radio-inline">
                                @foreach (json_decode($detailedProduct->colors) as $key => $color)
                                    <label class="aiz-megabox pl-0 mr-2 mb-0" data-toggle="tooltip" data-title="{{ \App\Models\Color::where('code', $color)->first()->name }}">
                                        ...
                                        <span class="aiz-megabox-elem rounded-0 d-flex align-items-center justify-content-center p-1">
                                            <span class="size-20px d-inline-block rounded" style="background: {{ $color }};"></span>
                                        </span>
                                    </label>
                                @endforeach
                            </div>
                ...
                <div class="row no-gutters mb-2">
                    <div class="col-sm-2">
                        <div class="text-secondary fs-14 fw-500 mt-2">{{ translate('Quantity')}}</div>
                    </div>
                    <div class="col-sm-10">
                        <div class="product-quantity d-flex align-items-center">
                            <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                                ...
                                <input type="number" name="quantity" 
                                    class="col border-0 text-center flex-grow-1 fs-14 input-number" placeholder="1" 
            ...
            <!-- Total Price -->
            <div class="row no-gutters pb-0 d-none" id="chosen_price_div">
                <div class="col-sm-2">
                   <!-- <div class="text-secondary fs-14 fw-500 mt-1">{{ translate('Total Price') }}</div> -->
                </div>
                <div class="col-sm-10">
