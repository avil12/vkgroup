...
@endphp
<div class="aiz-card-box   bg-white py-3 px-3 hov-scale-img" >
    <div class="position-relative h-240px  img-fit overflow-hidden">
        @php
    ...
    <div class="p-2 p-md-3 text-left">
        <!-- Product name -->
        <h3 class="fw-100 fs-14 text-truncate-2 lh-1-4 mb-0  text-center">
