...
<section class="text-light footer-widget border-bottom" style="border-color: #0000 !important; background-color: #1191d0 !important;
padding: 49px 0px 30px 0px;">
    <div class="container">
        <!-- footer logo -->
        <div class="mt-3 mb-4 footerlogo">
            <a href="{{ route('home') }}" class="d-block">
                @if(get_setting('footer_logo') != null)
                    <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}">
                @else
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-7">
                <div class="mb-4 text-white footdescrip text-justify">
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-4">
                ...
                @if ( get_setting('show_social_links') )
                    <h5 class="fs-18 fw-500 text-white text-uppercase mt-3 pb-2 mt-lg-0" id="connectus">Connect Us On</h5>
        ...
        <div class="row">
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
                    <h4 class="fs-18 text-white text-uppercase fw-500 mb-3">
                    ...
                    <ul class="list-unstyled">
                        @if ( get_setting('widget_one_labels',null,App::getLocale()) !=  null )
                            ...
                            <li class="mb-2">
                                <a href="{{ json_decode( get_setting('widget_one_links'), true)[$key] }}" style="color:#fff" class="fs-15 animate-underline-white">
                                    {{ $value }}
                                </a>
                            </li>
                            @endforeach
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
                    <h4 class="fs-18 text-white text-uppercase fw-500 mb-3" >Get In Touch</h4>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                        <p  class="fs-15" style="color:#fff">{{ get_setting('contact_address',null,App::getLocale()) }}</p>
                        </li>
                        <li class="mb-2">
                            <p  class="fs-15" style="color:#fff">{{ get_setting('contact_phone') }}</p>
                        </li>
                        <li class="mb-2">
                            <p  class="">
                                <a href="mailto:{{ get_setting('contact_email') }}" style="color:#fff" class="fs-15  hov-text-primary">{{ get_setting('contact_email')  }}</a>
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
                    <h4 class="fs-18 text-white text-uppercase fw-500 mb-3">{{ translate('My Account') }}</h4>
                    <ul class="list-unstyled">
                        @if (Auth::check())
                            <li class="mb-2">
                                <a class="fs-15  animate-underline-white" style="color:#fff" href="{{ route('logout') }}">
                                    {{ translate('Logout') }}
                                </a>
                            </li>
                        @else
                            <li class="mb-2">
                                <a class="fs-15  animate-underline-white" style="color:#fff" href="{{ route('user.login') }}">
                                    {{ translate('Login') }}
                                </a>
                            </li>
                        @endif
                        <li class="mb-2">
                            <a class="fs-15  animate-underline-white" style="color:#fff" href="{{ route('purchase_history.index') }}">
                                {{ translate('Order History') }}
                            </a>
                        </li>
                        <li class="mb-2">
                            <a class="fs-15  animate-underline-white" style="color:#fff" href="{{ route('wishlists.index') }}">
                                {{ translate('My Wishlist') }}
                            </a>
                        </li>
                        <li class="mb-2">
                            <a class="fs-15  animate-underline-white" style="color:#fff" href="{{ route('orders.track') }}">
                                {{ translate('Track Order') }}
                            </a>
                        </li>
                        @if (addon_is_activated('affiliate_system'))
                            <li class="mb-2">
                                <a class="fs-15  animate-underline-white" style="color:#fff" href="{{ route('affiliate.apply') }}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="text-center text-sm-left mt-4">
                    ...
                    @if (get_setting('vendor_system_activation') == 1)
                        <h4 class="fs-18 text-white text-uppercase fw-500 mb-3">{{ translate('Seller Zone') }}</h4>
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <p class="fs-15  mb-0" style="color:#fff">
                                    {{ translate('Become A Seller') }} 
                                    <a href="{{ route('shops.create') }}"  class="fs-15 fw-700 ml-2" style="color:red">{{ translate('Apply Now') }}</a>
                                </p>
                            </li>
                            @guest
                                <li class="mb-2">
                                    <a class="fs-15  animate-underline-white" style="color:#fff" href="{{ route('seller.login') }}">
...
<script type="text/javascript">
    (function () {
        var options = {
            whatsapp: "+918748800666", // WhatsApp number
