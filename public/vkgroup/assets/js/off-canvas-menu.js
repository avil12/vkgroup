                ...
                t.default = class {
                    constructor(e, t, o) {
                        (this.body = document.querySelector("body")),
                            (this.iconOpen = document.querySelector("." + n.CSS_CLASSES.ICON_OPEN)),
                            (this.sidebar = document.querySelector("." + n.CSS_CLASSES.SIDEBAR)),
                            (this.closeOtherSubMenus = e || !1),
                            (this.closeMenuOnBackdropClick = t || !0),
                            (this.closeSubMenusOnMenuClose = o || !0);
                    }
                    init() {
                        const e = document.querySelectorAll("." + n.CSS_CLASSES.LINK_LEVEL[1]),
                        ...
                        this.iconOpen.addEventListener("click", () => {
                            const e = document.querySelector("." + n.CSS_CLASSES.ICON_CLOSE),
                                t = [];
                            t.push(e), this.openMenu(this.sidebar, this.body), this.addCloseEvents(t, this.sidebar, this.body);
                        });
                    }
                    addBackdropToDom() {
                    ...
                    addCloseEvents(e, t, o) {
                        ...
                        for (let n = 0; n < e.length; n++) {
                            e[n].addEventListener("click", () => {
                                this.hideSidebar(t), this.removeBackdropFromDom(), this.makeBodyScrollable(o), this.closeSubMenusOnMenuClose && this.rotateMenuArrowsBack(), this.closeSubMenusOnMenuClose && this.closeAllSubMenus();
                            });
                        }
                    }
                    ...
                    closeAllSubMenus() {
                        const e = "." + n.CSS_CLASSES.SUBMENU_LEVEL[1] + ",." + n.CSS_CLASSES.SUBMENU_LEVEL[2],
                    ...
                    handleClickOnLevel(e, t) {
                        const o = e.currentTarget,
                            ...
                            c = s.childNodes[1];
                        l
                            ? ((r.style.display = "none"), c.classList.remove("rotate-90"), o.classList.remove("active"))
                            : (this.closeOtherSubMenus && this.closeAllSubMenus(), this.closeOtherSubMenus && this.rotateMenuArrowsBack(), (r.style.display = "block"), c.classList.add("rotate-90"), o.classList.add("active"));
                    }
                    handleSidebar(e) {
                        (e.className = n.CSS_CLASSES.SIDEBAR + " show"), (e.style.visibility = "visible");
                    }
                    hideSidebar(e) {
                    ...
                    openMenu(e, t) {
                        this.preventBodyFromScrolling(t), this.handleSidebar(e), this.addBackdropToDom();
                    }
